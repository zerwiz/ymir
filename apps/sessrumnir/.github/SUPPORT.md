...
- Check the [existing issues](https://github.com/zerwiz/ymir/issues) for duplicates.
- Make sure you are on the [latest release](https://github.com/zerwiz/ymir/releases).
- If the problem is in the Pi agent itself (not the GUI), report it [upstream](https://github.com/earendil-works/pi/issues).

## Links

- [Releases](https://github.com/zerwiz/ymir/releases)
