...
https://github.com/zerwiz/ymir/blob/main/CONTRIBUTING.md

Two things people miss most often:
1. PRs must target the `main` branch, not a fork's branch.
...
- [ ] This PR targets the `main` branch (not a fork's branch)
