...
# ///
"""factory Build Review — implement, then confirm it is what was asked for.

Usage:
    uv run factory/factory_build_review.py "<prompt or path/to/prompt.md>" [--config factory/factory_factory_config/factory.config.yaml] [--factory-id a1b2c3d4]
