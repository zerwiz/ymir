...
- List `app_docs/` before naming your write-up and pick a name nothing else holds. Two doc runs in one session share an `factory_id`, and an overwritten write-up describes a change that already shipped.
