...
```
python3 .agents/skills/galdr-ymirsystem/scripts/toon-check.py <file-or-dir> [...] [--quiet] [--json]
bash    .agents/skills/galdr-ymirsystem/scripts/compliance-check.sh [--quiet] [--json]
```
