...
skill_map[20]{upstream,norse,status}:
  ...
  "bearings","saga-bearings","adopted"
  "ahoy","saga-recap","adopted"
  "stow","muninn-stow","adopted"
  "project-management","jord-projects","adopted"
  "decision-hold-lifecycle","urdh-decisions","adopted"
  "captain-hold-lifecycle","urdh-hold","adopted"
  ...
  "process-event-sources","nornir-events","adopted"
  "quota-array-dispatch","nornir-quota","adopted"
  ...
  "updatefirstmate","ymir-update","adopted"
