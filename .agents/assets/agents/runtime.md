...
The full runtime spec is `.agents/skills/galdr-ymirsystem/assets/brokk-distro-runtime.md`.
...
PI boot assets: `.agents/skills/galdr-ymirsystem/assets/pi-boot/` (pi-profile.yml,
